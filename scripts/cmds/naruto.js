...
async function animeSong(api, event, args, message) {
 ...
 try {
 const animeSongResponse = await axios.get("https://naruto-edit.vercel.app/kshitiz");
 ...
 const writer = fs.createWriteStream(path.join(__dirname, "cache", `naruto.mp4`));
...
module.exports = {
 ...
 countDown: 10,
 role: 0,
 shortDescription: "naruto",
 longDescription: "get naruto anime edits",
 category: "anime",
 guide: "{p}naruto"
 },
